    ...
    while true do
        ...
        pcall(function()
            ...
            if not game.Players.LocalPlayer.PlayerGui:FindFirstChild("QuestUI") then
                ...
                local questName = game.Players.LocalPlayer.PlayerGui.QuestUI.QuestName.Text
                
                if IsMatchingQuest(MONName, questName) then
                    print("Quest matches monster:", MONName)
                else
                    print("Quest does not match monster:", MONName)
                end
            end
        end)
    end
