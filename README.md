-- ส่วนนี้เป็นส่วนของการเรียกใช้ฟังก์ชัน TP
function TP(targetCFrame)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = targetCFrame
end

-- ฟังก์ชัน MonA ในการกำหนดค่า MONName ตาม free
function MonA()
	free = free or "Bandit"
...
-- ฟังก์ชัน QuestA ในการกำหนดค่า CFrameQuest และ QuestZ ตาม free
function QuestA()
	if free == "Bandit" then
...
-- ฟังก์ชัน CheckLevel ในการตรวจสอบระดับและกำหนดค่า free และ QuestZ ตามเงื่อนไข
function CheckLevel()
    local MyLevel = tonumber(game.Players.LocalPlayer.PlayerGui.MainUI.Interface.PlayerStatus.Frame.Level.TextLabel.Text)
...
-- ฟังก์ชัน AA ในการใช้งาน AA
function AA()
	game:GetService('VirtualUser'):CaptureController()
	game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672))
end

-- ฟังก์ชัน A ในการใช้งาน A
function A()
	game:GetService('VirtualUser'):CaptureController()
	game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672))
end

-- ส่วนของการตั้งค่าเริ่มต้น
_G.Farn = true
...
-- ส่วนของการเปิด ProximityPrompt ทั้งหมดใน Workspace
spawn(function()
	while _G.Farn do
		wait()
		pcall(function()
...
-- ส่วนของการใส่อาวุธที่ชื่อ Combat
_G.Eq = true
...
-- ปลับดีเลในการรับเควสนานขึ้น
-- เช็คว่าถ้าเควสตรงกับมอนหรือบอสให้ทำต่อไปถ้าไม่ให้ไปเป็นตีมอนตัวนั้นต่ออีก 3 ตัว
while _G.Farn do
	wait()
	pcall(function()
		for _, v in pairs(game:GetService("Workspace"):GetDescendants()) do
